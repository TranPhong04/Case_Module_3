    ...
    <header class="header-section">
        <div class="container-fluid">
            <div class="inner-header">
                <div class="logo">
                    <a href="p"><img src="img/logo.png" alt=""></a>
                </div>
                <div class="header-right">
                    <img src="img/icons/search.png" alt="" class="search-trigger">
                    <a href="profile.jsp"><img src="img/icons/man.png"  alt=""></a>
                    <a href="#">
                ...
                <nav class="main-menu mobile-menu">
                    <ul>
                        ...
                        <li><a>Shop</a>
                            ...
                            <ul class="sub-menu">
                                <li><form action="/admin" method="get"><button type="submit" >Product Page</button></form></li>
